...
setIsMenu(prevState => !prevState);
    ...
    return (
       ...
       <CiSearch  />  
        ...
        <input placeholder="Search" className="  w-1/2 border border-gray-400 p-2 rounded-l-full pl-10 ml-20
          focus:border-blue-400 focus:outline-none " type="text" />
